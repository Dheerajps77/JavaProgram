...
public class FindUniqueElementsUsingMap {
	...
	public static void findUniqueWordInString() {
		try {
			...
			System.out.println("Words which occured only 1 time");
	...
	public static void findUniqueElementInCharacter() {
		try {
			...
			System.out.println("Below are the non-duplicate or unique character");
