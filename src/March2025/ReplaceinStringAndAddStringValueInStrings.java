...
public class ReplaceinStringAndAddStringValueInStrings {
	...
	public static void main(String[] args) {
		replaceInArrayNumberUsingStringbuilder();
	}

	public static void replaceInArrayNumber() {
		try {
	...
	public static void replaceInArrayNumberUsingStringbuilder() {
		try {

			int n[] = { 3, 5, 3, 4, 6, 7, 6, 4, 3, 45, 7, 8, 6, 4, 3, 4, 56, 7, 8, 6, 4, 3, 4, 6789 };
			int n1[] = new int[n.length];
			int temp = 0;
			int numToReplace = 6789;
			int num = 19011;
			StringBuilder builder = new StringBuilder();
			for (int i = 0; i < n.length; i++) {
				if (n[i] == numToReplace) {
			...
			String[] stringValue = builder.toString().split(" ");
			int[] newArr = new int[stringValue.length];
			int temp1 = 0;
			for (int i = 0; i < stringValue.length; i++) {
				newArr[temp1++] = Integer.parseInt(stringValue[i]);
			}
			
			System.out.println("Below are int array");
