...
public class ArrayNumberReverse {
	...
	public static void ReverseArrayNumber() {
		...
		/*
		 * Output Below are number before reverse :- 44 55 33 5 56 77 6 12 4 56
		 * 78 Below are the reversed array number :- 78 56 4 12 6 77 56 5 33 55
		 * 44
		 */
	}
	...
	public static void ReverseArrayString() {
		...
		/*
		 * Below are strings before reverse :- Hi Hello Bye Come on Shit Say it
		 * again !! Below are the reversed array strings :- Say it again !! Shit
		 * Come on Bye Hello Hi
		 */
	}
